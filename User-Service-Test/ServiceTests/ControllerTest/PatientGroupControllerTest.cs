...
namespace User_Service_Test.ServiceTests.ControllerTest
{
    public class PatientGroupControllerTest
    {
        ...
        public void GetPatientGroupByID_ReturnsPatientGroup()
        {
            ...
            var patientGroupController = new PatientGroupController(patientGroupServiceStub.Object);

            patientGroupServiceStub.Setup(service => service.GetPatientGroupByIdandTenant(expectedPatientGroup.Id, expectedOrganisation.Id))
